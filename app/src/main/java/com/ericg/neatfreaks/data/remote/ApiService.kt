...
package com.ericg.neatfreaks.data.remote

import com.ericg.neatfreaks.BuildConfig
import com.ericg.neatfreaks.data.remote.response.*
...
interface ApiService {
    ...
    suspend fun getTrendingMovies(
        ...
        @Query("api_key") apiKey: String = BuildConfig.NEATFREAKS_API_KEY,
